...
public final class FolderDao_Impl implements FolderDao {
  ...
  public FolderDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfFolderEntity = new EntityInsertionAdapter<FolderEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `folders` (`id`,`name`,`parent_id`,`color`,`icon`,`created_at`,`updated_at`) VALUES (nullif(?, 0),?,?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfFolderEntity = new EntityDeletionOrUpdateAdapter<FolderEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `folders` SET `id` = ?,`name` = ?,`parent_id` = ?,`color` = ?,`icon` = ?,`created_at` = ?,`updated_at` = ? WHERE `id` = ?";
      }
      ...
      public List<FolderEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new FolderEntity(_tmpId,_tmpName,_tmpParentId,_tmpColor,_tmpIcon,_tmpCreatedAt,_tmpUpdatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Flow<FolderEntity> getFolderById(final long id) {
      ...
      public FolderEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final long _tmpUpdatedAt;
            _tmpUpdatedAt = _cursor.getLong(_cursorIndexOfUpdatedAt);
            _result = new FolderEntity(_tmpId,_tmpName,_tmpParentId,_tmpColor,_tmpIcon,_tmpCreatedAt,_tmpUpdatedAt);
          } else {
            _result = null;
          }
          return _result;
  ...
  @Override
  public Flow<Integer> getNoteCountForFolder(final long folderId) {
    final String _sql = "SELECT COUNT(*) FROM notes WHERE folder_id = ? AND is_deleted = 0";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
  ...
  @Override
  public Object getAllFoldersOnce(final Continuation<? super List<FolderEntity>> $completion) {
